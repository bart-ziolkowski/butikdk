  ...
  ({ className }, ref) => {
    return (
      <div ref={ref} className={className}>
        <section className="text-gray-600 body-font relative text-center lg:pt-12">
          <h1 className="max-w-2xl mx-auto text-3xl font-bold leading-snug tracking-tight text-gray-800 lg:leading-tight lg:text-4xl dark:text-white">
            Contact or Visit Us
          </h1>
